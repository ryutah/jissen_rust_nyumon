...
mod tests {
    ...
    #[test]
    fn sort_studentes_by_age_ascending() {
        let taro = Studend::new("Taro", "Yamada", 16);
        let hanako = Studend::new("Hanako", "Yamada", 14);
        let kyoko = Studend::new("Kyoko", "Ito", 15);
        let ryosuke = Studend::new("Ryosuke", "Hayashi", 17);
